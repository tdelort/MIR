...
namespace mir
{
	todo_vulkan_render_device::todo_vulkan_render_device()
		: todo_vulkan_render_device( nullptr, nullptr, nullptr, nullptr )
	{ }

	todo_vulkan_render_device::todo_vulkan_render_device( VkPhysicalDevice _physical_device, VkDevice _logical_device, VkQueue _graphics_queue, VkQueue _present_queue )
	...
	todo_vulkan_render_device todo_vulkan_render_device_factory::create_todo_vulkan_render_device( VkSurfaceKHR _surface )
	{
		VkPhysicalDevice chosen_physical_device = VK_NULL_HANDLE;
		queue_families chosen_queue_families;
	
		VkInstance& vulkan_instance = todo_vulkan_rendering_service::instance().get_vulkan_instance();
		...
		VkQueue present_queue;
		{
			...
			const std::vector<const char*>& validation_layers = todo_vulkan_rendering_service::instance().get_vulkan_validation_layers();
		...
		return todo_vulkan_render_device(chosen_physical_device, logical_device, graphics_queue, present_queue);
	}

	void todo_vulkan_render_device_factory::release_todo_vulkan_render_device( todo_vulkan_render_device& _device )
	{
